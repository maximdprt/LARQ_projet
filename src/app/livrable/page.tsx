            ...
            <div className="flex gap-2 md:gap-4 min-w-max">
              {tabs.map((tab) => (
                <button
                  ...
                  className={`px-4 py-3 font-semibold text-sm md:text-base transition-colors whitespace-nowrap ${
                    activeTab === tab.id
...
function IntroductionTab() {
  return (
    <div className="space-y-8">
      {/* Hero Section */}
      <div className="text-center py-12 md:py-16 bg-gradient-to-br from-blue-50 to-white rounded-2xl px-6">
        <motion.h1
          initial={{ opacity: 0, y: -20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        <motion.a
          ...
          whileTap={{ scale: 0.95 }}
          className="inline-block px-8 py-4 bg-larq-blue text-white font-semibold rounded-lg hover:bg-larq-blue-light transition-colors duration-200 shadow-lg"
        >
          Nous contacter
        </motion.a>
      </div>
...
function ProblemeSolutionTab() {
  return (
    <div className="space-y-8">
      <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">2. Le Problème & La Solution</h2>
      
      <div className="grid md:grid-cols-2 gap-8">
        {/* Colonne Problèmes */}
        <div className="bg-red-50 rounded-xl p-6 md:p-8 border-2 border-red-100">
        ...
        {/* Colonne Solution */}
        <div className="bg-green-50 rounded-xl p-6 md:p-8 border-2 border-green-100">
          ...
          <div className="space-y-6">
            <div className="flex gap-4">
              ...
              <div>
                <h4 className="font-semibold text-gray-900 mb-2">Éradication</h4>
                <p className="text-gray-700 text-sm">
...
function MarcheTab() {
  return (
    <div className="space-y-8">
      <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">3. Axes de Communication & Analyse de Marché</h2>
      
      {/* Axes de communication */}
      <div className="mb-12">
        <h3 className="text-2xl font-bold text-gray-900 mb-6">Axes de Communication</h3>
        <div className="grid md:grid-cols-3 gap-6">
          <div className="bg-gradient-to-br from-pink-50 to-rose-50 rounded-xl p-6 border-2 border-pink-100">
            <div className="text-4xl font-bold mb-3">📱</div>
            <h4 className="text-xl font-bold text-gray-900 mb-2">TikTok</h4>
            <p className="text-gray-700">Mise en avant de notre produit via des contenus créatifs et engageants pour toucher un public jeune et connecté.</p>
          </div>
          <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl p-6 border-2 border-purple-100">
            ...
            <p className="text-gray-700">Visibilité premium avec des visuels esthétiques et des partenariats avec des influenceurs lifestyle et tech.</p>
          </div>
      ...
      <div>
        <h3 className="text-2xl font-bold text-gray-900 mb-6">Taille du Marché & Potentiel</h3>
        <div className="grid md:grid-cols-2 gap-8">
          <div className="bg-gradient-to-br from-larq-blue to-larq-blue-dark rounded-2xl p-8 text-white">
            <div className="text-5xl md:text-6xl font-bold mb-4">8.5</div>
          ...
          <div className="bg-gradient-to-br from-green-600 to-green-700 rounded-2xl p-8 text-white">
            ...
            <div className="text-2xl md:text-3xl font-semibold mb-2">CAGR</div>
            <p className="text-lg opacity-90">Marché de la Smart Bottle</p>
            <p className="text-sm mt-4 opacity-75">
...
function CroissanceTab() {
  ...
  return (
    <div className="space-y-8">
      <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">4. Perspectives de Croissance sur 3 Ans</h2>
          ...
          return (
            <div key={data.year} className="space-y-3">
              <div className="flex justify-between items-center">
                <div>
                  <h3 className="text-xl font-bold text-gray-900">{data.year} - {data.label}</h3>
                  <p className="text-sm text-gray-600">{data.units}</p>
                </div>
                <div className="text-right">
                  <div className="text-3xl font-bold text-larq-blue">{data.amount.toLocaleString('fr-FR')} €</div>
                </div>
              </div>
              ...
              <div className="relative w-full h-12 bg-gray-200 rounded-lg overflow-hidden">
                <motion.div
                  ...
                  className="h-full bg-gradient-to-r from-larq-blue to-larq-blue-light rounded-lg flex items-center justify-end pr-4"
                >
                  <span className="text-white font-semibold text-sm">{percentage.toFixed(0)}%</span>
                </motion.div>
              </div>
              
              <p className="text-sm text-gray-600 italic">{data.strategy}</p>
            </div>
          );
        })}
      </div>
        ...
        <table className="w-full border-collapse border border-gray-300 rounded-lg">
          <thead>
            <tr className="bg-larq-blue text-white">
              <th className="border border-gray-300 px-4 py-3 text-left">Année</th>
              <th className="border border-gray-300 px-4 py-3 text-left">Objectif CA</th>
              <th className="border border-gray-300 px-4 py-3 text-left">Volume estimé</th>
              <th className="border border-gray-300 px-4 py-3 text-left">Stratégie Clé</th>
            </tr>
          </thead>
          <tbody>
            {growthData.map((data) => (
              <tr key={data.year} className="hover:bg-gray-50">
                <td className="border border-gray-300 px-4 py-3 font-semibold">{data.year}</td>
                <td className="border border-gray-300 px-4 py-3 font-bold text-larq-blue">{data.amount.toLocaleString('fr-FR')} €</td>
                <td className="border border-gray-300 px-4 py-3">{data.units}</td>
                <td className="border border-gray-300 px-4 py-3 text-sm">{data.strategy}</td>
              </tr>
            ))}
          </tbody>
        </table>
...
function OpportuniteTab() {
  ...
  return (
    <div className="space-y-12">
      <div className="bg-larq-blue-dark text-white rounded-2xl p-8 md:p-12">
        <h2 className="text-3xl md:text-4xl font-bold mb-8 text-center">5. Pourquoi ce projet est une opportunité pour VOUS investisseur</h2>
        
        <div className="grid md:grid-cols-3 gap-6 mb-8">
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6">
            <div className="text-4xl mb-4">🚫</div>
            <h3 className="text-xl font-bold mb-3">Le refus du plastique</h3>
      ...
      {/* The Ask */}
      <div className="bg-gradient-to-br from-larq-blue to-larq-blue-dark rounded-2xl p-8 md:p-12 text-white">
        <h2 className="text-3xl md:text-4xl font-bold mb-6 text-center">6. Besoin de Financement (The Ask)</h2>
        ...
        <div className="space-y-6">
          <h3 className="text-2xl font-bold mb-6">Allocation des fonds</h3>
          
          {fundAllocation.map((item, index) => (
            <div key={item.category} className="bg-white/10 backdrop-blur-sm rounded-xl p-6">
              <div className="flex justify-between items-center mb-4">
                <h4 className="text-xl font-bold">{item.category}</h4>
                <div className="text-right">
                  <div className="text-2xl font-bold">{item.percentage}%</div>
                  <div className="text-sm opacity-75">{item.amount.toLocaleString('fr-FR')} €</div>
                </div>
              </div>
    ...
    <div className="space-y-8">
      ...
      <div className="bg-gradient-to-br from-larq-blue to-larq-blue-dark rounded-2xl p-8 md:p-12 text-white text-center">
        ...
        <motion.a
          ...
          whileHover={{ scale: 1.05 }}
          whileTap={{ scale: 0.95 }}
          className="inline-block px-8 py-4 bg-white text-larq-blue font-semibold rounded-lg hover:bg-gray-100 transition-colors duration-200 shadow-lg"
        >
