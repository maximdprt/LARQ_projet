    ...
    >
      ...
      <div className="p-4">
        ...
        <motion.button
          ...
          className={`w-full mt-4 px-4 py-2 font-medium rounded transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-larq-blue focus:ring-offset-2 ${
            addedToCart
