      ...
      <div className="bg-larq-blue-dark text-white py-3 px-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="ml-2 md:ml-4 px-3 md:px-4 py-1.5 bg-white text-larq-blue font-semibold rounded hover:bg-gray-100 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-larq-blue text-xs md:text-sm whitespace-nowrap"
          >
            EN SAVOIR PLUS
          </motion.button>
        </div>
      ...
      <AnimatePresence>
        {showModal && (
          <motion.div
            ...
            exit={{ opacity: 0, y: -20 }}
            className="fixed top-20 left-1/2 transform -translate-x-1/2 bg-white p-6 rounded-lg shadow-2xl z-50 max-w-md"
          >
